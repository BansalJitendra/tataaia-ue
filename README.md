...
## Environments
- Preview: https://main--tataaia-ue--BansalJitendra.aem.page/
- Live: https://main--tataaia-ue--BansalJitendra.aem.live/
...
1. Open the `tataaia-ue` directory in your favorite IDE and start coding :)