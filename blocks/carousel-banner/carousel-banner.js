 ...
 * A full-width promotional banner carousel (source: .banner-slider on tataaia.com).
 * One banner image per slide; slides auto-rotate and can be navigated via dots /
 * prev-next controls. Each slide holds a single image cell (optionally a linked
 * banner) with responsive desktop/mobile <picture> sources preserved from import.
 */
